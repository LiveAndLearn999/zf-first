<template>
  <div class="resuce_flex">
    <div class="resuce_flexlf" >
        <div class="resuce-title">员工列表</div>
        <div class="search-box">
                <el-input v-if="search_value == 0" v-model="SearchFormData.name" size="small" style="width: 60%;margin-right: 20px;height: 36px"/>
 ...
 type="selection"> </el-table-column>
    ...
    <div class="resuce_flexrg">
      ...
      <div class="search-box">
            <el-input v-if="search_value == 0" v-model="SearchFormData.names" size="small" style="width: 60%;margin-right: 20px;height: 36px"/>
      ...
      <div class="flex-footer" >已选员工 {{all_num}}</div>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    onSearchSubmits() {
      let teacherList = this.reces_rows.filter(array => array.name.match(this.SearchFormData.names));
