...
<template>
    <div>
        <el-row class="show-img">
            <el-col :span="6" v-for="(value,index) in fileListss" :key="index" >
                <img :src="value" alt="" style="width: 100px;height:100px" title="点击删除" @click="delimg(index)">
            </el-col>
            <!-- <el-col :span="6">
                <el-upload  :multiple="true"  
                :show-file-list="false"
            ...
            <div style="width: 120px;height: 120px;border: 1px solid lightgray; text-align: center; line-height: 120px;font-size: 30px">
                <i class="el-icon-plus"></i></div>                
        </el-upload>
            </el-col>  -->
        </el-row>
