  ...
  <div class="videoUpload">
    <div>
      <el-row>
       ...
       <el-row>
        <el-col :span="24">  <el-progress :percentage="authProgress"></el-progress></el-col>
      </el-row>
    </div>
    <div class="upload-type">
     ...
     <!-- 视频播放 -->
     <div v-if="videoPlayer1" class="prism-player" id="J_prismPlayer" style="width: 300px;height: 300px;"></div>
     <video v-if="videoPlayer2" width="320" height="240" :src="videoUrl" controls>
