            ...
            <el-table 
                ...
                size="mini" >
                    ...
                    <el-table-column prop="plate_number" label="车牌号">
                         <template slot-scope="scope">
                            {{scope.row.vehicle_info.plate_number}}
                        </template>
                    </el-table-column>
                    <el-table-column prop="dispatch_time" show-overflow-tooltip label="调度日期"></el-table-column>
                    <el-table-column prop="s_address" show-overflow-tooltip label="起送地"></el-table-column>
...
<<<<<<< HEAD
            <div class="draw-content" :style="{height:height - 80 +'px'}">
                    <el-form :model="AddFormData" label-width="160px" label-position="right" :rules="rules" ref="addform">
                        <el-row>
                            <el-col :span="12">
                            ...
                            <el-col :span="12">
                                <el-form-item label="托运人联系电话:" prop="consignor_phone">
                                    <el-input v-model="AddFormData.consignor_phone" />
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="装货人名称:" prop="loader">
                                    <el-input v-model="AddFormData.loader" />
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                 <el-form-item label="装货人联系:" prop="loader_phone">
                                    <el-input v-model="AddFormData.loader_phone"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="具体地址:" prop="s_address">
                                    <el-input v-model="AddFormData.s_address"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :span="24">
                                 <el-form-item label="目的地具体地址:" prop="e_address">
                                    <el-input v-model="AddFormData.e_address"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                         ...
                         <el-form-item label="货品信息:" required="">
                        <el-form label-width="100px" label-position="right" v-for="value in infoList"  :key="value.id" style="margin-top: 20px">
                                    <el-form-item label="货物类型:">
                                         <!-- v-model="good_value" -->
                                        <el-select
...
<<<<<<< HEAD
        ...
        <el-drawer
            ...
            :direction="direction" size="50%">
             <div slot="title">编辑</div>
            <div class="draw-content" :style="{height:height - 80 +'px'}">
                    <el-form :model="EditFormData" label-width="160px" label-position="right" :rules="rules" ref="editform">
                        <el-row>
                            <el-col :span="12">
                                 <el-form-item label="托运人名称:" prop="consignor">
                                    <el-input v-model="EditFormData.consignor" />
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="地址:" required>
                                    <ChooseAres v-if="hardReset" ref="starAdresss" :puuid="puuid" :cuuid="cuuid" :suuid="suuid"/> 
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                        ...
                        <el-row>
                            <el-col :span="24"> 
                                 <el-form-item label="目地地:" required>
                                     <ChooseAres v-if="hardReset" ref="starAdressss" :puuid="EditFormData.e_province_uuid" :cuuid="EditFormData.e_city_uuid" :suuid="EditFormData.e_area_uuid"/> 
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                        ...
                        <el-row>
                            ...
                            <el-col :span="12" required>
                                <el-form-item label="承运方:">
                                    <ChoosePeos ref="getPeoples" :puuid="EditFormData.carrier_uuid"/>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                            <el-col :span="12">
                                 <el-form-item label="参与人(参与派送):">
                                    <ChoosePeock ref="doPeoples" :peoary="EditFormData.participation_staff_list"/>
                                </el-form-item>
                            </el-col>
                             <el-col :span="12">
                                 <!-- <el-form-item label="企业归属车辆:">
                        ...
                        <el-row>
                            <el-col :span="12">
                                 <el-form-item label="企业归属车辆:">
                                    <ChooseVeh ref="ofVehs"/>
                                </el-form-item>
                            </el-col>
                        </el-row>

                         <el-form-item label="货品信息:">
                        <el-form label-width="100px" label-position="right" v-for="(value,index) in infoList"  :key="index" style="margin-top: 20px">
                                    <el-form-item label="货物类型:">
                                         <!-- v-model="good_value" -->
                                        <el-select
                                            style="width: 100%"
...
import Vue from "vue";
    ...
    // import TableBase from "@/components/myTables/baseTable.vue"
    import ChooseAre from "@/components/chooseAre/chooseAre.vue"
    import ChooseAres from "@/components/chooseAre/chooseAres.vue"
    import ChoosePeo from "@/components/choosePeople/choosePeo.vue"
    import ChoosePeos from "@/components/choosePeople/choosePeos.vue"
    import ChoosePeock from "@/components/choosePeople/choosePeock.vue"
    import ChooseVeh from "@/components/chooseVeh/chooseVeh.vue"
    import Bar from "@/components/myEcharts/bar.vue"
     import NProgress from 'nprogress'
    ...
    if (!store.state.EbShopData) {
        Vue.set(store.state, 'EbShopData', {
            rules: {
                consignor: [
                        { required: true, message: '托运人名称必填', trigger: 'blur' },
                ],
                consignor_phone: [
                     { required: true, message: '托运人联系电话必填', trigger: 'blur' },
                ],
                loader: [
                    { required: true, message: '装货人名称必填', trigger: 'blur' },
                ],
                loader_phone: [
                    { required: true, message: '装货人联系电话必填', trigger: 'blur' },
                ],
                consignee: [
                     { required: true, message: '收货人名称必填', trigger: 'blur' },
                ],
                consignee_phone: [
                    { required: true, message: '收货人联系电话必填', trigger: 'blur' },
                ],
                s_address: [
                    { required: true, message: '具体地址必填', trigger: 'blur' },
                ],
                e_address: [
                     { required: true, message: '目的地具体地址必填', trigger: 'blur' },
                ]
            },
...
<<<<<<< HEAD
                ...
                lime.req('EbDetail', {
                    ...
                    this.puuid = this.curr_row.s_province_uuid
                    this.cuuid = this.curr_row.s_city_uuid
                    this.suuid = this.curr_row.s_area_uuid
                    console.log('+++++')
                    this.infoList = res.data.distribution_goods 
                    // this.infoList[0].good_uuid = 'c638926c3f8e5d8b9ca7b59ff5c41446'
                    this.edit_show = true
                })
            ...
            onEditSubmit() {
                this.edit_show = false
                this.EditFormData.s_time = this.EditFormData.s_time ? util.eleDate(this.EditFormData.s_time) : ''
                this.EditFormData.dispatch_time = this.EditFormData.dispatch_time ? util.eleDate(this.EditFormData.dispatch_time) : ''
                this.EditFormData.s_area_uuid =  this.$refs.starAdresss.area_uuid
                this.EditFormData.e_area_uuid =  this.$refs.starAdressss.area_uuid
                this.EditFormData.carrier_uuid =  this.$refs.getPeoples.people_uuid
                this.EditFormData.participation_staff_uuids =  this.$refs.doPeoples.people_uuid
                this.EditFormData.main_staff_uuid =  this.$refs.doPeoples.people_uuid[0]
                // this.AddFormData.main_staff_uuid =  this.$refs.mdoPeople.people_uuid[0]
                this.EditFormData.shop_vehicle_uuid =  this.$refs.ofVehs.veh_uuid
              ...
              this.EditFormData.goods_json = '[' + as.substr(0, as.length - 1) + ']'
                lime.req('EbEdit',this.EditFormData).then( res => {
                    console.log(res)
                })
=======
                this.EditFormData = this.curr_row
