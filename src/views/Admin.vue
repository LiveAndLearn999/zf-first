    ...
    <div v-wechat-title="$route.meta.title">
            ...
            <div class="left">
                <div :style="{width:'100%', height:height - 62 +'px', overflow:'auto'}" class="topnav_box">
                    <el-menu
                        ...
                        <el-menu-item index="console" style="border: none!important;font-weight:600;font-family: 'Avenir,Helvetica,Arial,sans-serif'">控制台</el-menu-item>
                        <el-submenu 
        ...
        <el-drawer align="left"
            ...
            <div class="drawer-footer">
                <el-button  type="primary" @click="msg_show = false">关闭</el-button>
            </div>
        ...
        <el-dialog
            ...
            <el-tabs v-model="activeName" @tab-click="handleClicksss">
                <el-tab-pane  label="登录名管理" name="first">
                    <el-form ref="nameform" :rules="namerules" :model="myFormDate" label-width="80px" label-position="left">
                        <el-form-item label="用户名" prop="name">
                            <el-input prefix-icon="el-icon-user" v-model="myFormDate.name" style="width: 300px"></el-input>
                        </el-form-item>
                    </el-form>
                </el-tab-pane>
                <el-tab-pane label="密码管理" name="second">
                    <el-form ref="pwdform" :rules="namerules" :model="myFormDate" label-width="80px" label-position="left">
                        <el-form-item label="原密码" prop="old_pwd"><el-input  prefix-icon="el-icon-key" show-password type="password" style="width: 300px" v-model="myFormDate.old_pwd"></el-input></el-form-item>
                        <el-form-item label="新密码" prop="pwd">
                            <el-input prefix-icon="el-icon-key" style="width: 300px" show-password v-model="myFormDate.pwd" type="password"></el-input>
                        </el-form-item>
                    </el-form>
                </el-tab-pane>
            </el-tabs>
        ...
        created() {
            ...
            lime.req('ShopStaffSelfLoginInfo',{
                login_token: lime.cookie_get('login_token')
                 ...
                 this.set_uname = res.data.name
                 this.myFormDate.name = res.data.name
            })
            this.initMenuList();
        },
        mounted() {
