...
<<<<<<< HEAD
            width="450px">
            <el-form :rules="rules" ref="addform" :model="AddFormData" label-width="100px" label-position="right">
                <el-form-item label="计划组名称:" prop="name">
...
<<<<<<< HEAD
                        @change="close"
                        v-model="AddFormData.parent_uuid" style="width: 310px">
=======
                        v-model="AddFormData.parent_uuid" style="width: 360px">
>>>>>>> 69f72654eaa89f70eed7d5a40fa258b3f773fe8e
                    </el-cascader>
...
<<<<<<< HEAD
            width="450px">
            <el-form :rules="rules" ref="editform" :model="EditFormData" label-width="100px" label-position="right">
                <el-form-item label="计划名称:" prop="name">
                    <el-input v-model="EditFormData.name"/>
                </el-form-item>
                <!-- <el-form-item label="所属父类:">
...
>>>>>>> 69f72654eaa89f70eed7d5a40fa258b3f773fe8e
                    ...
                    ref="cascaderHandles"
                        ...
                        placeholder="请选择"
<<<<<<< HEAD
                        v-model="EditFormData.parent_uuid" style="width: 310px">
                    </el-cascader>
                </el-form-item> -->
=======
                        v-model="EditFormData.parent_uuid">
