...
=======
                ...
                <el-form :rules="rules" ref="addform" :model="AddFormData" label-width="140px" label-position="right">
                    ...
                    <el-form-item label="资源:" required>
                        <div v-if="re_ary" style="width: 99%; border-bottom: 1px solid #f2f2f2;">
                            ...
                            <div class="re-flexrg" @click="removeItm(index)">
                ...
                <el-form :model="EditFormData" label-width="140px" label-position="right">
                    ...
                    <el-form-item label="资源:" required>
                        <div v-if="edit_re_ary" style="width: 99%; border-bottom: 1px solid #f2f2f2;">
                            ...
                            <div class="re-flexlf">{{item.title}}</div>
                            <div class="re-flexmd">{{item.add_time}}</div>
                            <div class="re-flexrg" @click="removeItms">
                                <i class="el-icon-close"></i>
                            </div>
                        </div>
                        </div>
        ...
        <el-drawer
            ...
            :direction="direction" size="45%">
             ...
             <!-- <div class="drawer-footer">
                 <div style="padding: 0;width: 100%;display: flex;flex-direction: row;border: 1px solid red">
            ...
            <div class="draw-content" :style="{height:height - 80 +'px'}">
                <el-form :model="DetailFormData" label-width="150px" label-position="right">
                    ...
                    <el-row style="margin-top: 30px">
                        ...
                        <el-col :span="12">
                             <el-form-item label="计划分组:">{{DetailFormData.plan_group_uuid || '----'}}</el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                    ...
                    <el-row>
                        ...
                        <el-col :span="12">
                                <el-form-item label="实际:">{{DetailFormData.real_start || '---'}}</el-form-item>
                        </el-col>
                    </el-row>
                    <div class="line">
                        <div class="linelf"><div class="line-line"></div></div>
                        ...
                        <el-col :span="24">
                             <el-form-item label="学习资源:">
                                  <div v-if="DetailFormData.resource_list" style="width: 99%; border-bottom: 1px solid #f2f2f2;">
                                        ...
                                        <div class="re-flexlf" style="width: 35%">{{item.title}}</div>
                                        <div class="re-flexmd" style="width: 35%">{{item.content_time}}</div>
                                        <div class="re-flexrg" style="width: 30%">
                                            {{item.min_num}}
                                            <!-- <i class="el-icon-close"></i> -->
                                        </div>
                                    </div>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="学习过程拍照:">{{DetailFormData.study_process_photo}} 次</el-form-item>
                        </el-col>
                        <el-col :span="12">
                    ...
                    <el-row>
                        ...
                        <!-- <el-col :span="12">
                            <el-form-item label="学习过程学习:">{{DetailFormData.exam_process_photo}} 次</el-form-item>
                        </el-col> -->
                    </el-row>
                    <div class="line">
                        <div class="linelf"><div class="line-line"></div></div>
                    ...
                    <el-row style="margin-top: 30px">
                        ...
                        <!-- <el-col :span="12">
                            <el-form-item label="考试开始是否拍照:">{{DetailFormData.exam_start_photo}} 次</el-form-item>
                        </el-col> -->
                    </el-row>
                    <el-row>
                        <el-col :span="12">
    ...
    export default {
        ...
        methods:{
            ...
            onEditSubmit() {
                ...
                this.EditFormData.duration =  '"' + this.EditFormData.duration.toString() + '"'
                this.EditFormData.study_start_photo = this.edit_start_photo + ''
                 this.EditFormData.study_process_photo = '"' + this.EditFormData.study_process_photo.toString() + '"'
                this.EditFormData.study_end_photo = this.edit_end_photo - 0  + ''
                 this.EditFormData.exam_process_photo = '"' + this.EditFormData.exam_process_photo.toString() + '"'
            ...
            onAddSubmit() {
                ...
                this.AddFormData.duration =  '"' + this.AddFormData.duration.toString() + '"'
                this.AddFormData.study_start_photo = this.add_start_photo + ''
                // this.AddFormData.study_start_photo   + ''
                 this.AddFormData.study_process_photo = '"' + this.AddFormData.study_process_photo.toString() + '"'
                ...
                // this.AddFormData.exam_process_photo = this.AddFormData.exam_process_photo - 0  + ''
                 this.AddFormData.exam_process_photo = '"' + this.AddFormData.exam_process_photo.toString() + '"'
                ...
                ShopPlanDetail(pam, res => {
                    ...
                    this.plaingAry.forEach((item,index) => {
                        if(item.value === res.data.plan_group_uuid) {
                            that.DetailFormData.plan_group_uuid = item.label
                        }else {
                             that.DetailFormData.plan_group_uuid = '---'
                        }
                    })
