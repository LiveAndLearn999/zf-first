            ...
            <el-form :model="DetailFormData" label-width="120px" label-position="right">
              ...
              <el-row style="margin-top:20px">
                ...
                <el-row>
                  ...
                  <el-row>
                    <el-col :span="12">
                         <el-form-item  label="是否展示:">{{DetailFormData.data.is_show ? '否' : DetailFormData.data.is_show }}</el-form-item>
                    </el-col>
                     <el-col :span="12">
                ...
                <el-row>
                    <el-col :span="12">
                         <el-form-item v-if="DetailFormData.data.is_show"  label="展示时间:">{{DetailFormData.data.is_show }}</el-form-item>
                    </el-col>
                ...
                <el-row>
                    <el-col :span="24">
                        ...
                        <el-form-item label="答案:">
                            ...
                            <div v-if="add_ques !== 3 && add_ques !== 0" class="ques-add" @click="addopt">添加</div>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
       ...
       <el-drawer
            ...
            <div class="draw-content" :style="{height:height - 80 +'px'}">
                ...
                <el-row>
                    <el-col :span="12">
                         <el-form-item label="题型:" :required='true'>
                            <el-select v-model="edit_ques" placeholder="请选择">
                                <el-option
                                    v-for="item in ques_options"
                                    :key="item.value"
                                    :label="item.label"
    ...
    export default {
        ...
        methods:{
            ...
            onAddSubmit() {
                ...
                // console.log(this.add_show_value)
                // console.log(this.show_date)
                // console.log(this.AddFormData.title)
                this.AddFormData.login_token = lime.cookie_get('login_token')
                this.AddFormData.title = this.AddFormData.title
                this.AddFormData.is_pay = this.add_pay
                this.AddFormData.ques_type = this.add_ques - 0 + 1
                this.AddFormData.is_show = this.add_show_value == 0 ? this.add_show_value : this.show_date - 0
                let tagary = []
                if(this.$refs.tags.dynamicTags) {
                    this.$refs.tags.dynamicTags.forEach((item, index) => {
                        tagary[index] = item.uuid
