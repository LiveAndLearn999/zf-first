        ...
        <el-dialog  
            ...
            <el-form :model="EditFormData" label-width="80px" :rules="rules" ref="editform">
                ...
                <el-form-item label="使用状态:">
                    ...
                    <el-select v-model="edit_status_value" placeholder="请选择"  >
                            <el-option
                            v-for="item in status_options"
                            :key="item.value"
                            :label="item.label"
    ...
    export default {
        ...
        methods: {
            ...
            onAddSubmit() {
                ...
                this.AddFormData.sim_purchase_time = util.eleDate(this.add_time)
                this.AddFormData.use_status = this.status_value + ''
            ...
            handleEdit() {
                ...
                this.edit_time = this.curr_row.sim_purchase_time*1000
                this.edit_status_value = this.curr_row.use_status
            ...
            onEditSubmit() {
                ...
                this.EditFormData.netflow = this.EditFormData.netflow + ''
                this.EditFormData.sim_purchase = this.EditFormData.sim_purchase + ''
                this.EditFormData.ableflow = this.EditFormData.ableflow + ''
                this.EditFormData.sim_purchase_time = util.eleDate(this.edit_time)
                 this.EditFormData.use_status = this.edit_status_value + ''
