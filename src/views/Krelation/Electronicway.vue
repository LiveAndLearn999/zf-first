...
<!--
 * @Author: your name
 * @Date: 2020-09-10 17:49:07
 * @LastEditTime: 2020-09-10 17:49:39
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: /shop/src/views/Fsubsidiary/Statistic.vue
-->
        ...
        created() {
         ...
         methods: {
            ...
            NProgress.start();
                ...
                lime.req('EbRelationShopList',pam).then( res => {
                    NProgress.done();
...
<!--
 * @Author: your name
 * @Date: 2020-09-17 08:36:10
 * @LastEditTime: 2020-09-17 08:36:48
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: /shop/src/views/Krelation/Electronicway.vue
-->
<template>
    <h1>{{cpname}}</h1>
</template>
